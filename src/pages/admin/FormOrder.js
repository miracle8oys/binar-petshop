                                ...
                                <table className="table-auto border border-slate-400 divide-y divide-slate-400 min-w-full shadow-md">
                                    ...
                                    <tbody className="divide-y divide-slate-400">
                                        ...
                                        <tr key={index} className="">
                                            ...
                                            <td className="text-center">{item.product.weight}</td>
                                            <td className="text-center">{new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR" }).format(item.product.price)}</td>
