        ...
        <div className="h-screen w-full flex flex-col">
            ...
            <div className="flex bg-orange-50">
                ...
                <div className="flex-grow my-4 md:mx-20 mx-4 min-h-screen py-5">
                    <p className="font-bold md:text-2xl text-lg text-center pt-2 mb-6 ">Supplies Data</p>
                    ...
                    <table className="table-auto border border-slate-400 divide-y divide-slate-400 min-w-full shadow-md">
                        <thead className="bg-orange-50">
                            <tr className="">
                                ...
                                <th className="py-4 text-center">Supply Addition</th>
                            ...
                            <tr key={item?.id} className="">
                                ...
                                <td className="py-3">
                                    <div className="flex justify-center mb-2">
                                        <button onClick={() => navigate(`/admin/supplies/update/${item?.id}`)} type="button" name="update" className="py-2 font-bold w-32 bg-yellow-200 hover:bg-yellow-400 rounded-lg inline-flex items-center justify-center text-sm border border-slate-300"><BiEdit className="mr-3"/>Update</button>
                                    </div>
