            ...
            <div className="flex bg-orange-50">
                ...
                <div className="flex-grow my-4 md:mx-20 mx-4 min-h-screen py-5">
                    ...
                    <div className='mt-6 flex justify-between items-center mb-4'>
                        ...
                        <div className="">
                            <button type="button" onClick={() => navigate('/admin/tag/add')} className="bg-orange-200 p-3 hover:bg-orange-300 rounded-lg font-bold text-sm border border-slate-400">New Category</button>
                        </div>
                    </div>
                    <p className="font-bold mb-4">Total Data : {tags.length}</p>
