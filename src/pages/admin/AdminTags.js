...
const AdminTags = () => {
    ...
    useEffect(() => {
        fetch(`${base_url}/admin/v1/tags?title=${keyword}`, {
            method: "GET",
                headers: {
        ...
        <div className="h-screen w-full flex flex-col">
            ...
            <div className="md:flex bg-orange-50">
                ...
                <div className="flex-grow my-4 md:mx-20 mx-4 min-h-screen py-5">
                    <p className="font-bold md:text-2xl text-lg text-center pt-2 mb-6 ">Tag Data</p>
                    <div className='mt-6 md:flex justify-between items-center mb-4'>
                        ...
                        <div className="mt-4 md:mt-0">
                            <button type="button" onClick={() => navigate('/admin/tag/add')} className="bg-orange-200 p-3 hover:bg-orange-300 rounded-lg font-bold text-sm border border-slate-400">New Tag</button>
                        </div>
                    </div>
                        ...
                        <table className="table-auto border border-slate-400 divide-y divide-slate-400 min-w-full shadow-md text-sm lg:text-base">
                            ...
                            <tbody className="divide-y divide-slate-400">
                                ...
                                <tr key={item?.id} className="">
                                    ...
                                    <td className="text-center px-2">{new Date(item?.createdAt).toLocaleString('en-GB')}</td>
                                    <td className="py-3 px-2">
                                        <div className="flex justify-center mb-2">
                                            <button onClick={() => navigate(`/admin/tag/update/${item?.id}`)} type="button" name="update" className="py-2 font-bold w-32 bg-yellow-200 hover:bg-yellow-400 rounded-lg inline-flex items-center justify-center text-sm border border-slate-300"><BiEdit className="mr-3"/>Update</button>
                                        </div>
