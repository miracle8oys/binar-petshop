        ...
        <div className="h-screen w-full flex flex-col">
            ...
            <div className="lg:flex bg-orange-50">
                ...
                <div className="flex-grow my-4 mx-3 min-h-screen py-5">
                    ...
                    <div className='hidden mt-6 md:flex justify-between items-center mb-4'>
                        <section>
                        ...
                        <div className='basis-1/2'>
                            <div className='col-end-12'>
                                <div className='flex'>
                                    ...
                                    <button className="flex items-center justify-center px-4 border-l -ml-14 hover:bg-orange-200 rounded-full ">
                    ...
                    <div className='block md:hidden mt-6 items-center mb-4 gap-'>
                        <div className=''>
                            <div className=''>
                                <div className='flex'>
                    ...
                    <div className="overflow-x-auto">
                        <table className="table-auto border border-slate-400 divide-y divide-slate-400 min-w-full shadow-md ">
                            ...
                            <tbody className="divide-y divide-slate-400">
                                {orders?.map((item) => { 
                                return (
                                <tr key={item.id} className="text-sm lg:text-base">
                                    <td className="text-center px-2">{i++}.</td>
                                    <td className="text-center px-2 font-semibold">{item.address?.name}</td>
                                    <td className="text-center px-2">{item.grand_weight}</td>
                                    <td className="text-center px-2">{new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR" }).format(item.shipping_costs)}</td>
                                    <td className="text-center px-2">{new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR" }).format(item.grand_total)}</td>
                                    ...
                                    <td className="py-2 px-2">
                                        <div className="flex justify-center mb-2">
                                            <button onClick={() => navigate(`/admin/order/update/${item.id}`)} type="button" name="update" className="py-2 w-32 font-bold bg-yellow-200 hover:bg-yellow-400 rounded-lg inline-flex items-center justify-center text-sm border border-slate-300"><BiEdit className="mr-3"/>Update</button>
                                        </div>
