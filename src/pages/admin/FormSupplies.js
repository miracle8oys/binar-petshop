        ...
        <div>
            ...
            <div className="md:flex bg-orange-50">
                ...
                <div className="md:grid justify-center h-max min-h-screen w-full py-10">
                    <div className="h-fit w-full md:w-[50vw] border border-slate-400 px-2 sm:px-5 pt-4 shadow-2xl">
                        ...
                        <form onSubmit={handleSubmit} encType="multipart/form-data" className="grid my-8 gap-3 md:gap-3">
                            ...
                            <div className="flex justify-center mt-4">
                                <button type="submit" className="btn bg-orange-200 py-3 self-center w-full sm:w-40 rounded-md font-bold border border-slate-400 hover:bg-orange-300">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
