...
const ProductsCatalog = ({user}) =>{
    ...
    return (
        <>
            <div className='flex flex-col mb-auto h-screen w-full mx-auto'>
                <NavbarLayout user={user} />
                    ...
                    <Transition
                        ...
                        leaveFrom="opacity-100"
                        leaveTo="opacity-0">
                            <div className='md:mx-8 mt-6  mx-4 bg-gray-50 rounded-md px-3 pt-4 border'>
                    ...
                    <div className='container my-8 flex-grow'>
                    ...
                    <div className= 'container mb-5 flex-grow'>
                        <div className='md:mx-8 mx-4 px-3'>
